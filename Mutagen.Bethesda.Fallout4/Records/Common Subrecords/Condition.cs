...
namespace Mutagen.Bethesda.Fallout4
{
    ...
    namespace Internals
    {
        ...
        public partial class FunctionConditionDataBinaryOverlay
        {
            ...
            public FormLink<IFallout4MajorRecordGetter> ParameterOneRecord => new FormLink<IFallout4MajorRecordGetter>(FormKey.Factory(_package.MetaData.MasterReferences!, BinaryPrimitives.ReadUInt32LittleEndian(_data2)));

            public int ParameterOneNumber => BinaryPrimitives.ReadInt32LittleEndian(_data2);

            public FormLink<IFallout4MajorRecordGetter> ParameterTwoRecord => new FormLink<IFallout4MajorRecordGetter>(FormKey.Factory(_package.MetaData.MasterReferences!, BinaryPrimitives.ReadUInt32LittleEndian(_data2.Slice(4))));
