...
namespace Mutagen.Bethesda.Fallout4
{
    ...
    namespace Internals
    {
        public partial class MaterialObjectBinaryCreateTranslation
        {
            ...
            {
                if (item.FormVersion >= 44 || (frame.Remaining >= 8 && item.FormVersion == 43 && frame.MetaData.Constants.Release == GameRelease.Fallout4))
                {
        ...
        public partial class MaterialObjectBinaryWriteTranslation
        {
            ...
            {
                if (item.FormVersion >= 44 || (item.FormVersion == 43 && writer.MetaData.Constants.Release == GameRelease.Fallout4))
                {
        ...
        public partial class MaterialObjectBinaryOverlay
        {
            public MaterialObject.Flag GetFlagsCustom()
            {
                ...
                if (this.FormVersion >= 44 || (slice.Length >= 8 && this.FormVersion == 43 && this._package.MetaData.Constants.Release == GameRelease.Fallout4))
                {
