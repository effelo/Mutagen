...
namespace Mutagen.Bethesda.Fallout4
{
        ...
        IEquatable<IIngestibleGetter>
    {
        ...
        #endregion
        #region Addiction
        public FormLink<IFallout4MajorRecordGetter> Addiction { get; set; } = new FormLink<IFallout4MajorRecordGetter>();
        #endregion
        ...
        IFormLinkContainer
    {
        ...
        new FormLink<IFallout4MajorRecordGetter> Addiction { get; set; }
        ...
        IBinaryItem
    {
        ...
        FormLink<IFallout4MajorRecordGetter> Addiction { get; }
...
namespace Mutagen.Bethesda.Fallout4.Internals
{
    ...
    public partial class IngestibleSetterCommon : Fallout4MajorRecordSetterCommon
    {
        ...
        public void Clear(IIngestibleInternal item)
        {
            ...
            item.Value = default;
            item.Flags = default;
            item.Addiction = FormLink<IFallout4MajorRecordGetter>.Null;
    ...
    public partial class IngestibleCommon : Fallout4MajorRecordCommon
    {
        ...
        public Ingestible Duplicate(
            ...
            TranslationCrystal? copyMask)
        {
            var newRec = new Ingestible(formKey, default(Fallout4Release));
    ...
    public partial class IngestibleSetterTranslationCommon : Fallout4MajorRecordSetterTranslationCommon
    {
            ...
            bool deepCopy)
        {
            ...
            {
                item.Addiction = new FormLink<IFallout4MajorRecordGetter>(rhs.Addiction.FormKey);
            }
...
namespace Mutagen.Bethesda.Fallout4.Internals
{
        ...
        IIngestibleGetter
    {
        ...
        public FormLink<IFallout4MajorRecordGetter> Addiction => _Addiction_IsSet ? new FormLink<IFallout4MajorRecordGetter>(FormKey.Factory(_package.MetaData.MasterReferences!, BinaryPrimitives.ReadUInt32LittleEndian(_data.Span.Slice(_AddictionLocation, 0x4)))) : FormLink<IFallout4MajorRecordGetter>.Null;
        #endregion
        #region AddictionChance
