...
namespace Mutagen.Bethesda.Fallout4.Internals
{
    ...
    #region Common
    public partial class ImageSpaceSetterCommon : Fallout4MajorRecordSetterCommon
    {
    ...
    public partial class ImageSpaceCommon : Fallout4MajorRecordCommon
    {
        ...
        public ImageSpace Duplicate(
            ...
            TranslationCrystal? copyMask)
        {
            var newRec = new ImageSpace(formKey, default(Fallout4Release));
    ...
    public partial class ImageSpaceSetterTranslationCommon : Fallout4MajorRecordSetterTranslationCommon
    {
...
namespace Mutagen.Bethesda.Fallout4.Internals
{
    ...
    public partial class ImageSpaceBinaryCreateTranslation : Fallout4MajorRecordBinaryCreateTranslation
    {
            ...
            RecordTypeConverter? recordTypeConverter = null)
        {
            ...
            switch (nextRecordType.TypeInt)
            {
                ...
                {
                    item.Hdr = Mutagen.Bethesda.Fallout4.ImageSpaceHdr.CreateFromBinary(frame: frame);
                    return (int)ImageSpace_FieldIndex.Hdr;
                }
                case RecordTypeInts.CNAM:
                {
                    item.Cinematic = Mutagen.Bethesda.Fallout4.ImageSpaceCinematic.CreateFromBinary(frame: frame);
                    return (int)ImageSpace_FieldIndex.Cinematic;
                }
                case RecordTypeInts.TNAM:
                {
                    item.Tint = Mutagen.Bethesda.Fallout4.ImageSpaceTint.CreateFromBinary(frame: frame);
                    return (int)ImageSpace_FieldIndex.Tint;
                }
                case RecordTypeInts.DNAM:
                {
                    item.DepthOfField = Mutagen.Bethesda.Fallout4.ImageSpaceDepthOfField.CreateFromBinary(frame: frame);
