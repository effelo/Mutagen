using System;
using Noggog;
using static Mutagen.Bethesda.Fallout4.IPlaced;
...
namespace Mutagen.Bethesda.Fallout4
{
    public partial class APlaced : IPlaced
    {
        ...
        public bool Disable(DisableType disableType)
        {
            ...
            MajorRecordFlagsRaw = EnumExt.SetFlag(MajorRecordFlagsRaw, (int) Fallout4MajorRecordFlag.InitiallyDisabled, true);
            return true;
        }
    }
}