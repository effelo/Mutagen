...
namespace Mutagen.Bethesda.Fallout4
{
        ...
        IEquatable<IMusicTypeGetter>
    {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        IReadOnlyList<IFormLink<IMusicTrackGetter>>? IMusicTypeGetter.Tracks => _Tracks;
        #endregion
...
namespace Mutagen.Bethesda.Fallout4.Internals
{
    ...
    public partial class MusicTypeSetterCommon : Fallout4MajorRecordSetterCommon
    {
        ...
        public virtual void CopyInFromBinary(
            ...
            RecordTypeConverter? recordTypeConverter = null)
        {
            UtilityTranslation.MajorRecordParse<IMusicTypeInternal>(
                record: item,
                frame: frame,
                recordTypeConverter: recordTypeConverter,
    ...
    public partial class MusicTypeCommon : Fallout4MajorRecordCommon
    {
        ...
        #region Mutagen
        public IEnumerable<FormLinkInformation> GetContainedFormLinks(IMusicTypeGetter obj)
        {
        ...
        public MusicType Duplicate(
            ...
            TranslationCrystal? copyMask)
        {
            var newRec = new MusicType(formKey, default(Fallout4Release));
        ...
        IBinaryWriteTranslator
    {
            ...
            RecordTypeConverter? recordTypeConverter)
        {
            MajorRecordBinaryWriteTranslation.WriteRecordTypes(
                ...
                writer: writer,
                recordTypeConverter: recordTypeConverter);
            Mutagen.Bethesda.Binary.EnumBinaryTranslation<MusicType.Flag>.Instance.Write(
                writer,
                item.Flags,
                length: 4,
