...
namespace Mutagen.Bethesda.Fallout4.Internals
{
    ...
    public partial class LeveledSpellCommon : ASpellCommon
    {
        ...
        public static new LeveledSpell_FieldIndex ConvertFieldIndex(Fallout4MajorRecord_FieldIndex index)
        {
            switch (index)
            {
        ...
        public LeveledSpell Duplicate(
            ...
            TranslationCrystal? copyMask)
        {
            var newRec = new LeveledSpell(formKey, default(Fallout4Release));
