...
namespace Mutagen.Bethesda.Fallout4.Internals
{
    ...
    public partial class PlacedBeamCommon : APlacedTrapCommon
    {
        ...
        public static new PlacedBeam_FieldIndex ConvertFieldIndex(APlaced_FieldIndex index)
        {
            switch (index)
            {
        ...
        #region Mutagen
        public IEnumerable<FormLinkInformation> GetContainedFormLinks(IPlacedBeamGetter obj)
        {
        ...
        public PlacedBeam Duplicate(
            ...
            TranslationCrystal? copyMask)
        {
            var newRec = new PlacedBeam(formKey, default(Fallout4Release));
